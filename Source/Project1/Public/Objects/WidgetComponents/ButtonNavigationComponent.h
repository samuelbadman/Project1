...
public:
	...
	// Returns the button navigated to in the passed direction else null if navigation failed. Assumes the widget in the navigated direction is a project button
